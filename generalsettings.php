							...
							<div class="sj-manageallsession">
								<form class="sj-formtheme sj-managesessionform">
									<fieldset>
										<div class="form-group">
											<a href="javascript:void(0);" class="sj-btn sj-btnactive">Add New Edition</a>
										</div>
								...
								<ul class="sj-allcategorys">
									<li class="sj-addcategorys">
										<form class="sj-formtheme sj-categorysform">
											<fieldset>
												<div class="form-group">
													<input type="text" name="title" class="form-control" placeholder="Add edition Title Here">
												</div>
												<div class="form-group">
												...
												<div class="form-group sj-categorysbtn">
													<a href="javascript:void(0);" class="sj-checkbtn"><i class="ti-check"></i></a>
													<a href="javascript:void(0);" class="sj-btndecline">Cancel</a>
												</div>
											</fieldset>
										</form>
									</li>
									<li class="sj-categorysinfo">
										<div class="sj-title">
											<h3>Edition Title 02 <span>( June, 27, 2018 )</span></h3>
										</div>
						...
						<div id="sj-contentvtwo" class="sj-content sj-addarticleholdcontent sj-addarticleholdvtwo">
							...
							<div class="sj-manageallsession">
								<form class="sj-formtheme sj-managesessionform">
									<fieldset>
										<div class="form-group">
											<a href="javascript:void(0);" class="sj-btn sj-btnactive">Add New Category</a>
										</div>
										<div class="form-group sj-inputwithicon float-right">
											<i class="lnr lnr-sync"></i>
											<span class="sj-select">
...
<!-- Mirrored from amentotech.com/htmls/amentojourn/generalsettings.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:22:07 GMT -->
