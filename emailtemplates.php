							...
							<div class="sj-manageallsession">
								<form class="sj-formtheme sj-managesessionform">
									<fieldset>
										<div class="form-group">
											<button type="button" class="sj-btn sj-btnactive">Add New Template</button>
										</div>
								...
								<ul class="sj-allcategorys">
									<li class="sj-categorysinfo">
										<div class="sj-title">
											<h3>Email Template Title Here <span>( Jun 27, 2018 )</span></h3>
										</div>
...
<!-- Mirrored from amentotech.com/htmls/amentojourn/emailtemplates.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:22:07 GMT -->
