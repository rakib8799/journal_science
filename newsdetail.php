...
<!-- Mirrored from amentotech.com/htmls/amentojourn/newsdetail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:22:24 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<title>Amentojourn</title>
					...
					<div class="row">
						<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
							...
							<div class="sj-navigationarea">
								<strong class="sj-logo"><a href="index-2.html"><img src="images/logo.png" alt="company logo here"></a></strong>
									...
									<nav id="sj-nav" class="sj-nav navbar-expand-lg">
										...
										<div class="collapse navbar-collapse sj-navigation" id="navbarNav">
											<ul>
												...
												<li class="menu-item-has-children page_item_has_children current-menu-item">
								...
								<div id="sj-content" class="sj-content">
									<div class="sj-newsdetail">
										<div class="sj-head">
											...
											<h3>Toward Better-Quality Compounded Drugs</h3>
										</div>
										<figure class="sj-newsdetailimg">
											<img src="images/newsdetail/img-01.jpg" alt="image description">
										</figure>
										<div class="sj-tagssocialshare">
											<ul class="sj-posttags">
												<li>
													<a href="javascript:void(0);"><i class="lnr lnr-tag"></i><span>Lifestyle,</span></a>
												</li>
												<li>
										...
										<div class="sj-description">
											<p>Consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore elore lokate magna aliqua enim adminim sitae veniam, quis nostrud exercitation ullamcoaris nisiutia aliquip ex ea commodo consequat aute irure dolor reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
											<p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sedutana perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem eaque apsae quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
											<blockquote>
												<q>“Adipisicing sed do eiusmod tempor incididunt ut labore etaem dolore magna aliqua enim aliquip caquat.”</q>
												<div class="sj-clientname">
													<span><em>By:</em> Arnoldo Charpentier</span>
												</div>
											</blockquote>
											<p>Elit sed do eiusmod tempor incididunt ut labore elore lokate magna aliqua enim adminim sitae veniam, quis nostrud exercitation ullamcoaris nisiutia aliquip ex ea commodo consequat aute irure dolor reprehenderit in voluptate velitita esse cillum dolore eu fugiat nulla pariatur enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni doloresie eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet rolaem consectetur.</p>
										</div>
									</div>
									<div class="sj-author">
										<figure class="sj-authorimg">
											<img src="images/newsdetail/authorimg-01.jpg" alt="image description">
										</figure>
									...
									<div id="sj-comments" class="sj-comments">
										...
										<ul>
											<li>
												<div class="sj-author">
													<figure class="sj-authorimg">
														<img src="images/newsdetail/authorimg-02.jpg" alt="image description">
													</figure>
													<div class="sj-authorcontent">
														<div class="sj-authorhead">
															<div class="sj-leftarea">
																<div class="sj-authorname">
																	<h3>Arnoldo Charpentier</h3>
																	<span>03 Days Ago</span>
																</div>
															</div>
															<div class="sj-rightarea">
																<a class="sj-btnreply" href="javascript:void(0);"><i class="fa fa-reply"></i></a>
															</div>
														</div>
														<div class="sj-description">
															<p>ncididunt ut labore elore lokate magna aliqua enim adminim sitae veniam quis nostrud acitation ullamcoaris nisiutia aliquip ex ea commodo consequat aute irure dolor reprehenderit inoluptate velitita esse cillum dolore eu fugiat nulla pariatur enim ipsam voluptatem quia voluptas.</p>
												...
												<ul class="sj-childcomment">
													<li>
														<div class="sj-author">
															<figure class="sj-authorimg">
																<img src="images/newsdetail/authorimg-03.jpg" alt="image description">
															</figure>
															<div class="sj-authorcontent">
																<div class="sj-authorhead">
																	<div class="sj-leftarea">
																		<div class="sj-authorname">
																			<h3>Ryann Ridgeway</h3>
																			<span>05 Minutes Ago</span>
																		</div>
																	</div>
																	<div class="sj-rightarea">
																		<a class="sj-btnreply" href="javascript:void(0);"><i class="fa fa-reply"></i></a>
											...
											<li>
												<div class="sj-author">
													<figure class="sj-authorimg">
														<img src="images/newsdetail/authorimg-04.jpg" alt="image description">
													</figure>
													<div class="sj-authorcontent">
														<div class="sj-authorhead">
															<div class="sj-leftarea">
																<div class="sj-authorname">
																	<h3>Shantay Rieves</h3>
									...
									<div class="sj-leaveyourcomment">
										...
										<form class="sj-formtheme sj-formleavecomment">
											<fieldset>
												<div class="row">
													...
													<div class="col-12 col-sm-12 col-md-4 col-lg-4">
														<div class="form-group">
															<input type="email" name="yourmail" class="form-control" placeholder="Email">
														</div>
													</div>
													<div class="col-12 col-sm-12 col-md-4 col-lg-4">
														<div class="form-group">
															<input type="text" name="yoursubject" class="form-control" placeholder="Subject">
														</div>
													</div>
													<div class="col-12 col-sm-12 col-md-12 col-lg-12">
														<div class="form-group">
													...
													<div class="col-12 col-sm-12 col-md-4 col-lg-4">
														<button type="submit" class="sj-btn sj-btnactive">Submit</button>
													</div>
												</div>
											</fieldset>
										</form>
...
<!-- Mirrored from amentotech.com/htmls/amentojourn/newsdetail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:22:27 GMT -->
</html>