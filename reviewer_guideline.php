			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="sj-innerbannercontent">
						<h1>Reviewer Instructions/Guidelines</h1>
						<ol class="sj-breadcrumb">
							<li><a href="javascript:void(0);">Home</a></li>
							<li><a href="javascript:void(0);">Reviewer Guidelinest</a></li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div id="sj-content" class="sj-content">
							<div class="sj-authorguidelines">
								...
								<div class="sj-introduction sj-sectioninnerspace">
									<span>Information for Reviewers</span>
									<h4>A Complete Guideline</h4>
									<div class="sj-description">
										<ul>
											<li>Reviewers must give unbiased comments to each manuscript submitted.</li>
											<li>Reviewers must declare any conflict of interest before agreeing to review a manuscript.</li>
											<li>Reviewers must keep the peer review process confidential.</li>
											<li>Reviewers must not use artificial intelligence tools to generate manuscript review reports.</li>
											<li>Reviewers should make all reasonable effort to submit their report and recommendation on time. They should inform the editor if this is not possible.</li>
											<li>Reviewer should write to Editor if any significant similarity between the manuscript under consideration and any published paper is found.</li>
										</ul>
									</div>
								</div>
