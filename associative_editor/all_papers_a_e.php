                        ...
                        <table class = "table table-bordered table-hover text-center">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $select_from_new_paper = "SELECT * FROM `new_paper` WHERE `associative_editor_id` = '$_SESSION[associative_editor_id]' AND `paper_status`>=1";
                                        ...
                                        <tr>
                                            ...
                                            <?php 
                                                ...
                                                else if($row['paper_status']==4)
                                                {
                                                    ...
                                                    {
                                                        ?>
                                                            <td  class = "to_review fw-bold"><?php echo "Assigned Reviewer"?></td>
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                            <td  class = "to_review fw-bold"><?php echo "Assigned Reviewer <br> (Re-submitted)"?></td>
                                                        <?php
                                                    }
