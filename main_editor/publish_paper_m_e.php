                                                            ...
                                                            <div class="modal-content">
                                                               ...
                                                               <form action="" method = "POST">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <!-- Volume -->
                                                                        <h6 style = "text-align:left">Please Select Volume Number:<strong class = "text-danger">*</strong></h6>
                                                                        <select class = "form-control mb-2" name="volume" id="" required >
                                                                            <option value="" selected>Please Selecte Volume Number</option>
                                                                            <?php 
                                                                                $d = date('Y');
                                                                                for($i=2020,$j=1; $i<=$d;$i++,$j++)
                                                                                {
                                                                                    $vol = "Volume ".$j;
                                                                                    ?>
                                                                                        <option value="<?php echo $vol ?>"><?php echo $vol." (".$i.")"?></option>
                                                                                    <?php 
                                                                                }
                                                                            ?>
                                                                        </select>
